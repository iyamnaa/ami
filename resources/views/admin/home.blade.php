            ...
            <div class="fade-in">
                ...
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-primary">
                    <div class="card-body pb-0">
                      ...
                      <div class="text-value-lg">{{ $dataCount['campaigns'] }}</div>
                      <div class="mb-3">Campaign tersedia</div>
                    </div>
                  </div>
                </div>
                <!-- /.col-->
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-info">
                    <div class="card-body pb-0">
                      ...
                      <div class="text-value-lg">{{ $dataCount['users'] }}</div>
                      <div class="mb-3">Member bergabung</div>
                    </div>
                  </div>
                </div>
                <!-- /.col-->
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-warning">
                    <div class="card-body pb-0">
                      ...
                      <div class="text-value-lg">{{ $dataCount['donations'] }}</div>
                      <div class="mb-3">Donasi diterima</div>
                    </div>
                  </div>
                </div>
                <!-- /.col-->
                <div class="col-sm-6 col-lg-3">
                  <div class="card text-white bg-danger">
                    <div class="card-body pb-0">
                      ...
                      <div class="text-value-lg">{{ $dataCount['zakats'] }}</div>
                      <div class="mb-3">Zakat diterima</div>
                    </div>
                  </div>
                </div>
                <!-- /.col-->
              ...
              <div class="card">
                <div class="card-footer">
                  <div class="row mid-content mb-2 mt-2" align="center" style="width:100%">
                    <h3> Data Bulan Januari </h3>
                  </div>
